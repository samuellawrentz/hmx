...
v1 was a PHP fork of h-m-m (branch `main`; `git show php-ref:ref/hmx.php` on this branch); it proved the spec and was the behavioural reference for the port, retired once the Go binary passed the same tmux suite.
